public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // I had to change this from insert to add because it just needs to be added at the end of the queue
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //Lists do not start at 1, they start at 0
        _queue.RemoveAt(0);
        return value;
    }
}